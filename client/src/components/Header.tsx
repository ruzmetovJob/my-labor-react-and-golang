  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 bg-white w-full shadow-lg text-center visible md:invisible rounded-t-lg z-20">
        <div className="mx-4 flex justify-between space-x-6">

          <Link to="/" className={(active_path[0] == undefined ? 'text-[var(--current-dark)]' : 'text-gray-400') + " hover:text-gray-700 px-2 py-2 rounded-md text-sm font-small items-center justify-center"}>
          ...
          <Link to="/services" className={(active_path[0] == `/services` ? 'text-[var(--current-dark)]' : 'text-gray-400') + " hover:text-gray-700 px-2 py-2 rounded-md text-md font-medium items-center justify-center"}>
          ...
          <Link to="/ads" className={(active_path[0] == `/ads` ? 'text-[var(--current-dark)]' : 'text-gray-400') + " hover:text-gray-700 px-2 py-2 rounded-md text-md font-medium items-center justify-center"}>
          ...
          <Link to="/room" className={(active_path[0] == `/room` ? 'text-[var(--current-dark)]' : 'text-gray-400') + " hover:text-gray-700 px-2 py-2 rounded-md text-md font-medium items-center justify-center"}>
            <svg viewBox="0 0 24 24" className="w-8 h-8 mx-auto" fill="none" xmlns="http://www.w3.org/2000/svg">

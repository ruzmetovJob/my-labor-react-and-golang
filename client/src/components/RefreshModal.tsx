...
import img from "/public/imgs/html_css.svg"
...
export default function RefreshModal({ title, disc, handle }: RefreshModalProps) {
        ...
        <div className="relative z-30 select-none" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            */}
            ...
            <div className="fixed inset-0 z-30 overflow-y-auto">
                <m.div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0"
                    ...
                    */}
                    <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <img src={img} className='w-50 mx-auto' alt='refresh icon' />
                                    <h3 className="text-base font-semibold leading-6 text-gray-900 mt-2" id="modal-title">{title}</h3>
                                    <div className="mt-2">
                        ...
                        <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button type="button" className="inline-flex w-full justify-center rounded-md border border-transparent bg-blue-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm" onClick={e => handle(true)}>
                            ...
                            {/*<button type="button" className="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" onClick={e => handle(false)}>Cancel</button>*/}
                        </div>
                    </div>
                </m.div>
            </div>

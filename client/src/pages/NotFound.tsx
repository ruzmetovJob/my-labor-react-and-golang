...
export default function NotFound() {
  ...
  return (
    <Motion>
    <div className="relative isolate min-h-full flex items-center justify-center z-0">
        ...
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
            <div>
              ...
              <div>
                <h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">{Str['page-not-found']}</h1>
                <p className="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Dastur test rejimida ishga tushirilgani sabab, ayrim sahifalar ishlamastligi mumkin.</p>
                <div className="mt-8 flex gap-x-4 sm:justify-center">
                  <a onClick={e => {navigete(-1)}} className="inline-block rounded-lg bg-teal-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-teal-600 hover:bg-teal-700 hover:ring-teal-700 cursor-pointer">
                    <span className="text-indigo-200" aria-hidden="true">&larr; </span> 
                    {Str['go-back']}
                  </a>
                  <Link to="/" className="inline-block rounded-lg px-4 py-1.5 text-base font-semibold leading-7 text-gray-900 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                    {Str['main-page']}

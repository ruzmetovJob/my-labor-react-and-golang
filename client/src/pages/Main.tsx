...
import styles from 'assetss/style';
      ...
      <PageContent>
        <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6">
          <div className='grid grid-cols-2 gap-6'>
            ...
            <Link to='/services'>
              <m.div variants={fadeIn("right", "spring", 1 * 0.5, 0.75)} className='bg-white rounded-xl shadow-md text-gray-600 hover:text-[var(--bs-primary)] p-6'>
        ...
        <div className='min-h-screen'>
          <m.div variants={textVariant(200)}>
            <p className={styles.sectionSubText}>Introduction</p>
            <span className={styles.sectionHeadText}>Overview</span>
          </m.div>
          <m.p
